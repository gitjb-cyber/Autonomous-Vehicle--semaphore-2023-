...
const byte address[6] = "34567"; // 메인 오더에게 보낼 채널 주소
String now_mode = "receive"; // nRF24L01의 기본 형태를 수신형으로 설정

int drvcos = 1;  // 1:직진, 2:우회전, 3:좌회전
String line_number = "C"; // 사거리 A:하, B:좌, C:상, D:우
...
// 운행모드 2번
    ...
    if(now_mode == "send"){  // 메인 주소로 보내는 코드
      ...
      String new_msg = "2_RC_CAR"; // 1번 차에서 보내는 메시지를 알림
